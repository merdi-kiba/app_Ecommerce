 ...
 */
final class Version20230313112857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE is_payer (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE payement_produit DROP FOREIGN KEY FK_522D60BAA76ED395');
        $this->addSql('ALTER TABLE payement_produit DROP FOREIGN KEY FK_522D60BAF347EFB');
        $this->addSql('DROP TABLE payement_produit');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE is_payer');
    }
}
