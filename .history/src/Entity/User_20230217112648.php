...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?InfoPayement $infoPayement = null;
    ...
    public function getInfoPayement(): ?InfoPayement
    {
        return $this->infoPayement;
    }

    public function setInfoPayement(?InfoPayement $infoPayement): self
    {
        $this->infoPayement = $infoPayement;
