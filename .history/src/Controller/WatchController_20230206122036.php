...
{
    #[Route('/watch.html', name: 'app_watch', methods: ['GET'])]
    ...
    #[Route('/watch/create.html', name: 'app_watch_create', methods: ['GET', 'POST'])]
    ...
    #[Route('/watch/{id<\d+>}/edit.h', name: 'app_watch_edit', methods: ['GET', 'POST'])]
