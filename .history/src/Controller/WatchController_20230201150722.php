...
class WatchController extends AbstractController
{
    ...
    public function index(WatchRepository $watchRepository, Request $request): Response
    {
        ...
        $watchHom = $watchRepository->findforhome(1);



        return $this->render('watch/index.html.twig', compact('watch','watchHome','watchHom'));
    }
    ...
    #[Route('/watch/edit/{id<\d+>}', name: 'app_watch_edit', methods: ['GET', 'POST'])]
